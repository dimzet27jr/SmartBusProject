...
namespace SmartBusProject
{
    partial class CartForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // EmptyCart
            // 
            EmptyCart.BackColor = Color.FromArgb(212, 163, 115);
            ...
            EmptyCart.Location = new Point(139, 524);
            EmptyCart.Name = "EmptyCart";
            EmptyCart.Size = new Size(244, 37);
        ...
        private Panel CreateCartItemPanel(CartItem product)
        {
            ...
            btnRemove.BackColor = Color.FromArgb(212, 163, 115);
