...
namespace SmartBusProject
{
    partial class VacuumForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            ControlsPanel.Controls.Add(btnBack);
            ...
            btnBack.Location = new Point(3, 468);
            ...
            // btnCharge
            // 
            btnCharge.BackColor = Color.Transparent;
            btnCharge.BackgroundImage = Properties.Resources.charge_icon;
            btnCharge.BackgroundImageLayout = ImageLayout.Stretch;
            btnCharge.Cursor = Cursors.Hand;
            btnCharge.FlatAppearance.BorderSize = 0;
            btnCharge.FlatStyle = FlatStyle.Flat;
            btnCharge.ForeColor = Color.White;
            btnCharge.Location = new Point(264, 396);
            btnCharge.Name = "btnCharge";
            btnCharge.Size = new Size(64, 68);
            ...
            BatteryPersent.Location = new Point(222, 422);
            ...
            // BatteryLife
            // 
            BatteryLife.Location = new Point(16, 422);
            ...
            BatteryTitle.Location = new Point(16, 396);
            ...
            ModesSelections.Items.AddRange(new object[] { "Auto", "Spot", "Quick" });
            ...
            Text = "Vacuum";
            FormClosing += Vacuum_FormClosing;
